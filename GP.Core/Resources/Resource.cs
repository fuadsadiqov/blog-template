namespace GP.Core.Resources
{
    ...
    public static class ResourceKey
    {
        ...
        public const string AllowedFileNameFormat = "ALLOWED_FILE_NAME_FORMAT";
        
        public const string AllowedFileMimeType = "ALLOWED_FILE_MIME_TYPE";
        public const string AllowedFolderNameFormat = "ALLOWED_FOLDER_NAME_FORMAT";
        ...
        public const string DmOpenRequestIsAvailable = "DM_OPEN_REQUEST_IS_AVAILABLE";
        public const string DmShouldAssignExecutive = "DM_SHOULD_ASSIGN_EXECUTIVE";


        public const string DirectoryExist = "DIRECTORY_EXIST";
