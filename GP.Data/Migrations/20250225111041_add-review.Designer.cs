...
namespace GP.Data.Migrations
{
    ...
    [Migration("20250225111041_add-review")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GP.Domain.Entities.Common.Blog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GP.Domain.Entities.Common.BlogTag", b =>
                {
                    ...
                    b.ToTable("BlogTags", "cmn");
                });

            modelBuilder.Entity("GP.Domain.Entities.Common.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Categories", "cmn");
                });

            modelBuilder.Entity("GP.Domain.Entities.Common.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Reviews", "cmn");
                });

            modelBuilder.Entity("GP.Domain.Entities.Common.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GP.Domain.Entities.Common.Blog", b =>
                {
                    b.HasOne("GP.Domain.Entities.Common.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("GP.Domain.Entities.Common.BlogTag", b =>
                {
                    b.HasOne("GP.Domain.Entities.Common.Blog", "Blog")
                        .WithMany("Tags")
                        .HasForeignKey("BlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GP.Domain.Entities.Common.Tag", "Tag")
                        .WithMany("Blogs")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
