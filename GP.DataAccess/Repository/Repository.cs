...
namespace GP.DataAccess.Repository
{
        ...
        where T : class,IEntity, new()
    {
        ...
        public virtual void Delete(T entity, bool soft = true)
        {
            ...
            if (soft)
            {
                ...
                entity.Status = RecordStatusEnum.Deleted;
            }
            else
            {
        ...
        public virtual void DeleteWhere(Expression<Func<T, bool>> predicate, bool soft = true)
        {
